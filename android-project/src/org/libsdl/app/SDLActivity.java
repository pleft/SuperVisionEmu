...
import com.pylm.supervision.KeyCodes;
import com.pylm.supervision.R;
import com.pylm.supervision.VirtualDPad;
...
public class SDLActivity extends Activity {
    ...
    private void loadOnScreenControls() {
        ...
        mOnScreenControls.put("START", this.findViewById(R.id.startButton));
        mOnScreenControls.put("SELECT", this.findViewById(R.id.selectButton));
        mOnScreenControls.put("B", this.findViewById(R.id.bButton));
        mOnScreenControls.put("A", this.findViewById(R.id.aButton));
     ...
     */
    private View.OnTouchListener touchControlsListener = new View.OnTouchListener() {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_POINTER_DOWN:
                ...
                if (controlId.contains("DPAD")) {
                    ...
                    mVstickLastPos = pos;
                    mVstickPosition = pos;
                } else if (controlId.contains("START")) {
                    SDLActivity.onNativeKeyDown(KeyCodes.KEY_START);
                } else if (controlId.contains("SELECT")) {
                    SDLActivity.onNativeKeyDown(KeyCodes.KEY_SELECT);
                } else if (controlId.contains("A")) {
                    SDLActivity.onNativeKeyDown(KeyCodes.KEY_A);
                } else if (controlId.contains("B")) {
                    SDLActivity.onNativeKeyDown(KeyCodes.KEY_B);
                }
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (controlId.contains("DPAD")) {
                    ...
                    SDLActivity.onNativeKeyUp(KeyCodes.KEY_START);
                } else if (controlId.contains("SELECT")) {
                    SDLActivity.onNativeKeyUp(KeyCodes.KEY_SELECT);
                } else if (controlId.contains("A")) {
                    SDLActivity.onNativeKeyUp(KeyCodes.KEY_A);
                } else if (controlId.contains("B")) {
                    SDLActivity.onNativeKeyUp(KeyCodes.KEY_B);
                }
